    ...
    function clampTimeBankToSegment(segment, atIso = nowIso()) {
      const remainingSegmentSeconds = getRemainingSegmentSeconds(segment.end, atIso);
    ...
    function syncTimerToSegment(segment, atIso = nowIso()) {
      ...
      const segmentStartIso = getSegmentBoundaryIso(segment.start, atIso);
    ...
    function recalculateTimeBankSeconds() {
      state.timeBankSeconds = state.completions
        ...
        .reduce((sum, app) => {
          ...
          const remainingSegmentSeconds = getRemainingSegmentSeconds(segment.end, app.at);
